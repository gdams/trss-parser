...
## Usage
```bash
trss-parser <parentId> # Where parentID comes from https://trss.adoptopenjdk.net/
```
...
TRSS [link](https://trss.adoptopenjdk.net/buildDetail?parentId=5f60dc9a11d26031c17a9f11&testSummaryResult=failed&buildNameRegex=%5ETest) 
...
jdk_lang_0 => [deep history 6/27 passed](https://trss.adoptopenjdk.net/deepHistory?testId=5f60f83711d26031c17ab408) 
jdk_util_0 => [deep history 6/27 passed](https://trss.adoptopenjdk.net/deepHistory?testId=5f60f83711d26031c17ab406) 
...
MBCS_Tests_unicode_linux_0 => [deep history 0/27 passed](https://trss.adoptopenjdk.net/deepHistory?testId=5f60f82e11d26031c17ab245) 
MBCS_Tests_codepoint_linux_0 => [deep history 0/27 passed](https://trss.adoptopenjdk.net/deepHistory?testId=5f60f82e11d26031c17ab177) 
```
...
Go to https://trss.adoptopenjdk.net/ and select a pipeline run that you are triaging.
This will take you to a new page such as:
```
https://trss.adoptopenjdk.net/buildDetail?parentId=5f60f57611d26031c17aac90
```
